...
class Slack {
    ...
    public function postMessagesToSlack_rollingkpi($message, $room) {
        ...
        $icon = ":robot_face:";
        $data = "payload=" . json_encode(array("channel" => "#{$room}","username" =>"Rolling KPI", "text" => $message));
        //$data1 = "payload=" . json_encode($data, $options, $depth)
    ...
    public function postMessagesToSlack_productionreport($message, $room) {
        ...
        $icon = ":robot_face:";
        $data = "payload=" . json_encode(array("channel" => "#{$room}","username" =>"24 HRS Production Report", "text" => $message));
        //$data1 = "payload=" . json_encode($data, $options, $depth)
